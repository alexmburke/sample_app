IntercomRails.config do |config|
  # == Intercom app_id
  #
  config.app_id = ENV["INTERCOM_APP_ID"] || "z6rb8a8o"

  # == Intercom secret key
  # This is required to enable secure mode, you can find it on your Setup
  # guide in the "Secure Mode" step.
  #
  config.api_secret = "5kQQLr9IR_lUzHsx-HgIqL_3bsYv1sTHImPtEEiv"
  ...
  #
  config.api_key = "108bae61fd806ff50aa3023dd7359101441a4094"
